...
def main():
    ...
    st.title("FaceEditor App")
    st.text("Build with Streamlit, OpenCV & \u2764\uFE0F by Kavya Goel")

    activities = ["Detection", "About"]
    choice = st.sidebar.selectbox("Select Activty", activities)

    if choice == 'Detection':
        st.subheader("Face Editing")
        ...
        st.markdown(
            "Built with Streamlit by [Kavya Goel](https://www.sagnik.tech/)")
        st.success("Kavya Goel")
